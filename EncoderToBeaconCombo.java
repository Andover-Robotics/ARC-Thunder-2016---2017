...
/**
 * Created by Lake Yin on 3/8/2017.
 */
...
@Autonomous(name="Put the robot along the wall while having it target the middle of the white line or the corner of the same square it is in", group="Encoders")
public class EncoderToBeaconCombo extends LinearOpMode {
	...
	private String allianceColor;						// Color of our alliance
    ...
    allianceColor = "Blue"				// Set this to the color of our alliance which is either "Blue" or "Red"
